...
const EditClientModal: React.FC<EditClientModalProps> = ({ client, onClose, onSave, uniqueCrms }) => {
  ...
  useEffect(() => {
    if (client) {
      setFormData({
        ...
        averageOrderSize: client.averageOrderSize || '',
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-xl overflow-hidden flex flex-col">
        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
          <h2 className="text-lg font-black text-slate-800 flex items-center">
            <i className="fa-solid fa-pen-to-square mr-3 text-indigo-600"></i>
            Edit Client
          </h2>
          <button 
            onClick={onClose}
